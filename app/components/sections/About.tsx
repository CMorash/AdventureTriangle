...
export default function About() {
  return (
    <motion.section
      ...
      style={{ 
        isolation: 'isolate',
        background: 'linear-gradient(to bottom, rgba(255, 255, 255, 0.25), rgba(255, 255, 255, 0.50))'
      }}
    >
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          <Card>
            <h3 className="text-2xl font-bold text-neutral-900 mb-4">What We Offer</h3>
